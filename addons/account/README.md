...
The Zira <a href="https://www.korajac.com/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. Zira's user interface is designed with productivity in mind.
...
accounting; Zira has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

Zira supports multiple currencies, multiple users with different access rights,
