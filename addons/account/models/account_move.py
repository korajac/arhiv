...
from zira.exceptions import RedirectWarning, UserError, ValidationError
from zira.tools.misc import formatLang, format_date
from zira.tools import float_is_zero, float_compare
...
class AccountMoveLine(models.Model):
    ...
    def _apply_taxes(self, vals, amount):
        tax_lines_vals = []
        # Get ids from triplets : https://www.korajac.com/documentation/10.0/reference/orm.html#zira.models.Model.write
