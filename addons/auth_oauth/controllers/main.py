...
from zira import api, http, SUPERUSER_ID, _
from zira.exceptions import AccessDenied
from zira.http import request
from zira import registry as registry_get

from zira.addons.auth_signup.controllers.main import AuthSignupHome as Home
from zira.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via Zira Account provider"""
        ...
        with registry.cursor() as cr:
            try:
                ...
                provider = env.ref('auth_oauth.provider_ziraerp')
            except ValueError:
