...
from zira.tests.common import TransactionCase, can_import
from zira.modules.module import get_module_resource
from zira.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('zira.addons.base_import.models.base_import')
