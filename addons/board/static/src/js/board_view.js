zira.define('board.BoardView', function (require) {
"use strict";
    ...
    _createController: function (params) {
        ...
        return this._rpc({
            ...
            .then(function (action) {
                ...
                // override the https://github.com/zira/zira/pull/28408language to take the current one
...
zira.define('board.viewRegistry', function (require) {
"use strict";
