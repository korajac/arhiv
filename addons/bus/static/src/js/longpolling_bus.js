zira.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether zira is focused or not
     *
     * @returns {boolean}
     */
    isZiraFocused: function () {
        return this._isZiraFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isZiraFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isZiraFocused);
        }
    },
    /**
