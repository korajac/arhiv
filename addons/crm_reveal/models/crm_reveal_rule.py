...
from zira.addons.iap import jsonrpc
from zira.addons.crm.models import crm_stage
from zira.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.korajac.com'
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.reveal.industry', string='Industry Tags', help='Leave empty to always match. Zira will not create lead if no match')
    ...
    # Methods responsible for format response data in to valid zira lead data
