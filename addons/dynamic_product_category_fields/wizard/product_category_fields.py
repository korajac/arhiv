...
from zira import api, models, fields, _


class ProductCategoryDynamicFields(models.TransientModel):
    _name = 'product.category.dynamic.fields'
    ...
    def create_fields(self):
        self.env['ir.model.fields'].sudo().create({'name': self.name,
                                                   ...
                                                   'copy': self.copy,
                                                   'active': True})
        inherit_id = self.env.ref('product.product_category_form_view')
        ...
        self.env['ir.ui.view'].sudo().create({'name': 'product.category.dynamic.fields',
                                              'type': 'form',
