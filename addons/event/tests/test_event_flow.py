...
from zira.addons.event.tests.common import TestEventCommon
from zira.exceptions import ValidationError, UserError, AccessError
from zira.tools import mute_logger
from zira.fields import Datetime
try:
...
class TestEventFlow(TestEventCommon):
    ...
    def test_event_date_range(self):
        self.patcher = patch('zira.addons.event.models.event.fields.Datetime', wraps=Datetime)
