zira.define('im_support.SupportMessage', function (require) {
"use strict";
...
var SupportMessage = Message.extend({
    ...
    init: function () {
        ...
        if (this._serverAuthorID !== this.call('mail_service', 'getZirabotID')) {
    ...
    getAvatarSource: function () {
        return '/mail/static/src/img/zira_o.png';
    },
    /**
