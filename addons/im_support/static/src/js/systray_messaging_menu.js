zira.define('im_support.systray.MessagingMenu', function (require) {
"use strict";
...
MessagingMenu.include({
    ...
    init: function () {
        ...
        this.supportChannel = {
            ...
            name: _t("Zira Live Support"),
            title: _t("Zira Live Support"),
            imageSRC: '/mail/static/src/img/zira_o.png',
        };
    },
    /**
