...
from zira.tools import float_repr
from zira.exceptions import UserError, ValidationError
from zira.addons.base.models.ir_mail_server import MailDeliveryException
from zira.tests.common import Form
        ...
        for invoice in self:
            ...
            if len(invoice.commercial_partner_id.l10n_it_pa_index or '') == 6:
                invoice.message_post(
                    body=(_("Invoices for PA are not managed by Zira, you can download the document and send it on your own."))
                )
                invoice.l10n_it_send_state = "other"
                continue
