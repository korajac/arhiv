...
from zira import api, release, SUPERUSER_ID
from zira.exceptions import UserError
from zira.models import AbstractModel
from zira.tools.translate import _
from zira.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Zira's publisher warranty server to check the
