zira.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isZirabotAuthor()) {
            return '/mail/static/src/img/zirabot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or Zirabot messages
     * (note: Zirabot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isZirabotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If Zirabot is the author (default author for transient messages),
     * returns 'Zirabot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is ZiraBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isZirabotAuthor: function () {
        return this._serverAuthorID === this.call('mail_service', 'getZirabotID');
    },
    /**
