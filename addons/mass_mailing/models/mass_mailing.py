...
from zira import api, fields, models, tools, _, SUPERUSER_ID
...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@korajac.com; yti@example.com
        # B (id=5): yti@korajac.com; yti@ziraerp.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@korajac.com              |          1 |        4 |
        #           6 | yti@korajac.com              |          2 |        5 |
        #           5 | yti@example.com           |          1 |        4 |
        #           7 | yti@ziraerp.com           |          1 |        5 |
        #
...
class MassMailing(models.Model):
    ...
    mail_server_id = fields.Many2one('ir.mail_server', string='Mail Server',
        ...
        help="Use a specific mail server in priority. Otherwise Zira relies on the first outgoing mail server available (based on their sequencing) as it does for normal mails.")
