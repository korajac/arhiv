...
import logging
import json
from zira import api, fields, models, exceptions, _
from zira.addons.iap import jsonrpc
from requests.exceptions import ConnectionError, HTTPError
from zira.addons.iap.models.iap import InsufficientCreditError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://partner-autocomplete.korajac.com'
