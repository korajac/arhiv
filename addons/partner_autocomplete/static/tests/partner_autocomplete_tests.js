zira.define('partner_autocomplete.tests', function (require) {
    "use strict";
    ...
    QUnit.module('partner_autocomplete', {
        before: function () {
            var suggestions = [
                {name: "Zira", website: "korajac.com", domain: "korajac.com", logo: "korajac.com/logo.png", vat: "BE0477472701"}
            ];
            ...
            testUtils.patch(AutocompleteCore, {
                ...
                _getZiraSuggestions(value, isVAT) {
                ...
                _getClearbitSuggestions(value) {
                    return this._getZiraSuggestions(value);
                },
            });
        ...
        createView({
            ...
            mockRPC: function (route, args) {
                ...
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "korajac.com/logo.png"
                    || route === "data:image/png;base64,zirabase64") { // land here as it is not valid base64 content
                    return $.when();
                }
            ...
            assert.strictEqual($input.val(), "Zira", "Input value should have been updated to \"Zira\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "korajac.com", "website value should have been updated to \"korajac.com\"");
            ...
            $input.val("zira").trigger("input");
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing zira letters again");
