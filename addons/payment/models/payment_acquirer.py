...
from zira.tools import consteq, float_round, image_resize_images, image_resize_image, ustr
from zira.addons.base.models import ir_module
from zira.exceptions import ValidationError
from zira import api, SUPERUSER_ID
from zira.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
from zira.tools.misc import formatLang
...
class PaymentAcquirer(models.Model):
    ...
    Korajac and the acquirer. It generally consists in return urls given to the
    ...
    capture_manually = fields.Boolean(string="Capture Amount Manually",
        help="Capture the amount from Zira, when the delivery is completed.")
