...
from zira.addons.payment_authorize.controllers.main import AuthorizeController
...
class AuthorizeForm(AuthorizeCommon):
    ...
    @mute_logger('zira.addons.payment_authorize.models.payment', 'ValidationError')
...
@zira.tests.tagged('post_install', '-at_install', '-standard')
class AuthorizeForm(AuthorizeCommon):
    def test_30_authorize_s2s(self):
        ...
        # add credential
        # FIXME: put this test in master-nightly on zira/zira + create sandbox account
        authorize.write({
