...
from zira.tools import DEFAULT_SERVER_DATE_FORMAT
...
class TestUi(zira.tests.HttpCase):
    def test_01_pos_basic_order(self):
        ...
        self.phantom_js("/pos/web",
                        "zira.__DEBUG__.services['web_tour.tour'].run('pos_pricelist')",
                        "zira.__DEBUG__.services['web_tour.tour'].tours.pos_pricelist.ready",
                        login="admin")

        self.phantom_js("/pos/web",
                        "zira.__DEBUG__.services['web_tour.tour'].run('pos_basic_order')",
                        "zira.__DEBUG__.services['web_tour.tour'].tours.pos_basic_order.ready",
                        login="admin")
