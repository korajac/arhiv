...
from zira.tools import float_compare, mute_logger, test_reports, pycompat
from zira.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('zira.addons.point_of_sale.models.pos_order'):
