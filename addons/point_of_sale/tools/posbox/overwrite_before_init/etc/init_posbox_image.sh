...
mkdir -v /var/log/zira
chown pi:pi /var/log/zira
chown pi:pi -R /home/pi/zira/
...
echo "* * * * * rm /var/run/zira/sessions/*" | crontab -
...
echo "addons/hw_drivers/drivers/" > /home/pi/zira/.git/info/exclude
