...
from zira.addons.portal.controllers.portal import CustomerPortal, pager as portal_pager
from zira.tools import groupby as groupbyelem

from zira.osv.expression import OR
