...
from zira.tests.common import TransactionCase, Form
...
class TestSaleMrpProcurement(TransactionCase):
    ...
    def test_sale_mrp(self):
        ...
        # In order to test the sale_mrp module in Korajac, I start by creating a new product 'Slider Mobile'
        # I define product category Mobile Products Sellable.

        with mute_logger('zira.tests.common.onchange'):
