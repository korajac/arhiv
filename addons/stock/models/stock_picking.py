...
from zira import api, fields, models, _, SUPERUSER_ID
from zira.osv import expression
from zira.tools import DEFAULT_SERVER_DATETIME_FORMAT
from zira.tools.float_utils import float_compare, float_is_zero, float_round
from zira.exceptions import UserError
from zira.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        'Show Reserved', default=True, help="If this checkbox is ticked, Zira will show which products are reserved (lot/serial number, source location, source package).")
