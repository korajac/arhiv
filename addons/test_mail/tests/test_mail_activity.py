...
from zira import exceptions, tests
from zira.addons.test_mail.tests.common import BaseFunctionalTest
from zira.addons.test_mail.tests.common import mail_new_test_user
from zira.addons.test_mail.models.test_mail_models import MailTestActivity
