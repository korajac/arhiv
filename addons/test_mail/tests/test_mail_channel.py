...
from zira.exceptions import AccessError, except_orm, ValidationError, UserError
...
class TestChannelAccessRights(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('zira.addons.base.models.ir_model', 'zira.models')
    ...
    @mute_logger('zira.addons.base.models.ir_model', 'zira.models', 'zira.models.unlink')
...
class TestChannelFeatures(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('zira.addons.mail.models.mail_mail', 'zira.models.unlink')
...
class TestChannelModeration(common.Moderation):
    ...
    @mute_logger('zira.addons.mail.models.mail_channel', 'zira.models.unlink')
    ...
    @mute_logger('zira.models.unlink')
