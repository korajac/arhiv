...
from zira.addons.test_mass_mailing.tests.common import MassMailingCase
from zira.addons.base.models.ir_config_parameter import IrConfigParameter
from zira.tests.common import TransactionCase, users
