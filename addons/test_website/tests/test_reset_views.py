...
class TestWebsiteResetViews(zira.tests.HttpCase):
    def do_test(self, name):
        self.browser_js(
            "/",
            "zira.__DEBUG__.services['web_tour.tour'].run('%s')" % name,
            "zira.__DEBUG__.services['web_tour.tour'].tours.%s.ready" % name,
            login="admin"
        )
    ...
    @mute_logger('zira.addons.website.models.ir_http')
    ...
    # @mute_logger('zira.addons.website.models.ir_http', 'zira.addons.website.models.ir_ui_view')
