...
class IrTranslation(models.Model):
    ...
    def _get_transifex_url(self):
        ...
        # e.g. 'https://www.transifex.com/zira/'
        ...
        for addon_path in ad_paths:
            ...
            if os.path.isfile(tx_path):
                ...
                # first section is [main], after [zira-11.sale]
                tx_sections.extend(tx_config_file.sections()[1:])

            # parent directory ad .tx/config is root directory in zira/zira
        ...
        if not base_url or not tx_sections:
            ...
            # using ini files like '[zira-master.website_sale]'
            ...
            for translation in self:
                ...
                # e.g. https://www.transifex.com/zira/zira-10/translate/#fr/sale/42?q=text'Sale+Order'
