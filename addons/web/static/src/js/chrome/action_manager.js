zira.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that Zira actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute Zira actions, given as an ID in
     ...
     * @private
     * @param {ZiraEvent} ev
     * @param {ZiraEvent} ev.data.controllerID
     */
