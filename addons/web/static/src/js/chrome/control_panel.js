zira.define('web.ControlPanelMixin', function (require) {
"use strict";
...
zira.define('web.ControlPanel', function (require) {
"use strict";
...
var ControlPanel = Widget.extend({
     ...
     * @param {ziraerp.web.SearchView} [status.searchview] the searchview widget
