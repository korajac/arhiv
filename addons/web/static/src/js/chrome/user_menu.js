zira.define('web.UserMenu', function (require) {
"use strict";
...
var UserMenu = Widget.extend({
            ...
            callback: function () {
                self._rpc({route: '/web/session/account'})
                    ...
                    .fail(function (result, ev){
                        ev.preventDefault();
                        framework.redirect('https://accounts.korajac.com/account');
                    });
            },
        });
    },
    ...
    _onMenuDocumentation: function () {
        window.open('https://www.korajac.com/documentation/12.0', '_blank');
    },
    /**
     * @private
     */
    ...
    _onMenuSupport: function () {
        window.open('https://www.korajac.com/buy', '_blank');
    },
    /**
     * @private
     */
