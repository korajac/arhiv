zira.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Zira.
 *
 * The basic concurrency primitives in Zira JS are the callback, and the
...
return {
    ...
    /**
     * A (Zira) mutex is a primitive for serializing computations.  This is
