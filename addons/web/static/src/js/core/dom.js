zira.define('web.dom_ready', function (require) {
'use strict';
...
zira.define('web.dom', function (require) {
"use strict";
 ...
 * functionalities with the zira framework.  A common theme in these functions
...
var dom = {
    ...
    /**
     * Renders a button with standard zira template. This does not use any xml
    ...
    /**
     * Renders a checkbox with standard zira/BS template. This does not use any
