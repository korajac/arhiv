zira.define('web.framework', function (require) {
"use strict";
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="ziraerp oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the ziraerp server to be reachable before reloading
