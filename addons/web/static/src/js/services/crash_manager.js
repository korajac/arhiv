zira.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = core.Class.extend({
    ...
    show_warning: function(error) {
        ...
        return new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("Zira Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("Zira Error"),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type) || _t("Zira Warning"),
            buttons: [
...
core.crash_registry.add('zira.exceptions.RedirectWarning', RedirectWarningHandler);

function session_expired(cm) {
    return {
        display: function () {
            cm.show_warning({type: _t("Zira Session Expired"), data: {message: _t("Your Zira session expired. Please refresh the current web page.")}});
        }
    }
}
core.crash_registry.add('zira.http.SessionExpiredException', session_expired);
...
zira.define('web.crash_manager', function (require) {
"use strict";
