(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = zira.__DEBUG__.services['web.AbstractController'];
        var Discuss = zira.__DEBUG__.services['mail.Discuss'];
        var WebClient = zira.__DEBUG__.services["web.WebClient"];
