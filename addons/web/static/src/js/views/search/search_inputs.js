zira.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` Korajac field type:
 *
...
/**
 * Implementation of the ``datetime`` ziraerp field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {ziraerp.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the Korajac filters (button with a context and/or
