 ...
 * QUnit Config
 *
 * The Zira javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * Zira.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an Zira module, because we want this code to be executed
 * as soon as possible, not whenever the Zira module system feels like it.
 */
 ...
 * this is done outside of zira modules, otherwise the setting would not take
 * effect on time.
 */
