...
Also, adds methods to convert values back to Zira models.
"""
...
from zira.tools import ustr, posix_to_ldml, pycompat
from zira.tools import html_escape as escape
from zira.tools.misc import babel_locale_parse
from zira.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = zira.modules.get_module_resource(
