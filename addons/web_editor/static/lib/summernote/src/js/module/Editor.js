define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // ZIRA: allow access for override
    this.table = table;   // ZIRA: allow access for override
    this.typing = typing; // ZIRA: allow access for override
    this.bullet = bullet; // ZIRA: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // ZIRA: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // ZIRA: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // ZIRA: addition
        $(anchor).css(linkInfo.style || {}); // ZIRA: addition
        if (isNewWindow) {
