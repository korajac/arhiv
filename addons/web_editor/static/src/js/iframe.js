zira.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.zira[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.zira[callback + '_editor']) {
                window.top.zira[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.zira[callback + '_downup']) {
                    window.top.zira[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
zira.define('root.widget', function (require) {
'use strict';
...
zira.define('web_editor.IframeRoot', function (require) {
'use strict';
