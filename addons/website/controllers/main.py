...
from zira import http, models, fields, _
from zira.http import request
from zira.tools import pycompat, OrderedSet
from zira.addons.http_routing.models.ir_http import slug, _guess_mimetype
from zira.addons.web.controllers.main import Binary
from zira.addons.portal.controllers.portal import pager as portal_pager
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'modules': modules,
            'version': zira.service.common.exp_version()
        }
