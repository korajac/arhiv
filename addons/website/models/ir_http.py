...
import zira
from zira import api, models, registry
...
from zira.osv.expression import FALSE_DOMAIN, OR

from zira.addons.base.models.qweb import QWebException
from zira.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
from zira.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from zira.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _handle_exception(cls, exception):
        ...
        if not is_website_request:
            ...
            if isinstance(exception, zira.exceptions.AccessError):
                code = 403
            ...
            if isinstance(exception, QWebException):
                ...
                if type(exception.error) == zira.exceptions.AccessError:
                    code = 403
