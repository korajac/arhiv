...
zira.define('website.WebsiteRoot', function (require) {
'use strict';
...
var WebsiteRoot = BodyManager.extend({
    ...
    start: function () {
        ...
        this.$('.zoomable img[data-zoom]').zoomZira();
    ...
    _multiCompanySwitch: function (ev) {
        ...
        this._rpc({model: 'res.users',
            method: 'write',
            args: [zira.session_info.user_id, {'company_id': parseInt(company_id_to_switch_to, 10)}],
        }).then(function () {
