function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('zira-google-map'), {
        zoom: 1,
    ...
    if (zira_partner_data){ /* zira_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < zira_partner_data.counter; i++) {
            set_marker(zira_partner_data.partners[i]);
        }
