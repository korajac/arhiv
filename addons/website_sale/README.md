...
Zira is an <a href="https://www.korajac.com/page/e-commerce">Open Source eCommerce</a>
...
Zira's unique *'edit inline'* and building blocks approach makes product pages
...
Zira's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Zira's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Zira marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Zira proposes
...
SEO tools are ready to use, with no configuration required. Zira suggests
...
Create new landing pages easily with the Zira inline edition feature. Send
...
Benefit from the power of Zira, in your online store: a powerfull tax engine,
...
Everything is integrated with Zira. No pain, real time.
