...
class TestWebsiteSaleZoom(zira.tests.HttpCase):
    ...
    def test_01_admin_shop_zoom_tour(self):
        ...
        self.phantom_js("/", "zira.__DEBUG__.services['web_tour.tour'].run('shop_zoom')", "zira.__DEBUG__.services['web_tour.tour'].tours.shop_zoom.ready", login="admin")
