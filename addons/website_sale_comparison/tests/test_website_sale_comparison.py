...
class TestWebsiteSaleComparison(zira.tests.TransactionCase):
...
class TestUi(zira.tests.HttpCase):
    ...
    def test_01_admin_tour_product_comparison(self):
        self.phantom_js("/", "zira.__DEBUG__.services['web_tour.tour'].run('product_comparison')", "zira.__DEBUG__.services['web_tour.tour'].tours.product_comparison.ready", login='admin')
