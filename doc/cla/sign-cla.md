...
In order for your contribution to Zira to be accepted, you have to sign the
Zira Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [zira/zira](/zira/zira), adding a new file `<github-login>.md` under the
...
3. An Zira R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [zira/zira](/zira/zira), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is Zira, the file would be
    `doc/cla/corporate/zira.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Zira Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `korajac.com`.  In that case someone from the Zira team will
make the pull request on your behalf.

* Printable Zira CCLA v1.0 https://www.korajac.com/files/legal/Zira-CCLA-v1.0.pdf
* Printable Zira ICLA v1.0 https://www.korajac.com/files/legal/Zira-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Zira is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Zira project

* protect the Zira project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Zira project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Zira project under specific
...
The Zira CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Ražanica d.o.o. to use, modify and
...
(ICLA) of Zira.  The agreement is executed by adding your name and
