...
from zira.http import Controller, dispatch_rpc, request, route
from zira.service import wsgi_server
from zira.fields import Date, Datetime
from zira.tools import lazy


class ZiraMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = ZiraMarshaller
...
class RPC(Controller):
    ...
    def jsonrpc(self, service, method, args):
        """ Method used by client APIs to contact Korajac. """
