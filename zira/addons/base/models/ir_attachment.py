...
from zira import api, fields, models, tools, SUPERUSER_ID, exceptions, _
from zira.exceptions import AccessError, ValidationError
from zira.tools import config, human_size, ustr, html_escape
from zira.tools.mimetypes import guess_mimetype
from zira.tools import crop_image, image_resize_image
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any ziraerp document.
