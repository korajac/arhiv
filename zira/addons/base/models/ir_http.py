...
import zira
from zira import api, http, models, tools, SUPERUSER_ID
from zira.exceptions import AccessDenied, AccessError
from zira.http import request, STATIC_CACHE, content_disposition
from zira.tools import pycompat, consteq
from zira.tools.mimetypes import guess_mimetype
from ast import literal_eval
from zira.modules.module import get_resource_path, get_module_path
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls):
        if not hasattr(cls, '_routing_map'):
            ...
            if tools.config['test_enable'] and zira.modules.module.current_test:
                installed.add(zira.modules.module.current_test)
            mods = [''] + zira.conf.server_wide_modules + sorted(installed)
