...
from zira import api, models, tools
from zira.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from zira.http import request
from zira.modules.module import get_resource_path

from zira.addons.base.models.qweb import QWeb, Contextifier
from zira.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from zira.addons.web.controllers.main import module_boot
