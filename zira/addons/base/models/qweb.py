...
from zira.tools import pycompat, freehash, wrap_values
    ...
    def _base_module(self):
        ...
        * string_types (replacement for basestring)
        ...
        return ast.parse(dedent("""
            ...
            from zira.tools.pycompat import to_text, string_types
            from zira.addons.base.models.qweb import escape, foreach_iterator
            """))
