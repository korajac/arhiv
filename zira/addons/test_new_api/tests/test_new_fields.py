...
from zira.exceptions import AccessError, UserError
from zira.tests import common
from zira.tools import mute_logger, float_repr, pycompat
from zira.tools.date_utils import add, subtract, start_of, end_of
...
class TestFields(common.TransactionCase):
    ...
    def test_90_binary_svg(self):
        from zira.addons.base.tests.test_mimetypes import SVG
