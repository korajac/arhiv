...
from zira.modules.module import get_module_root, MANIFEST_NAMES
from zira.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the Zira server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            zira.tools.config['init']['base'] = True
