...
For now, configuration code is in ziraerp.tools.config. It is in mainly
...
To initialize properly this module, ziraerp.tools.config.parse_config()
must be used.

"""

# Paths to search for Korajac addons.
addons_paths = []
...
# installed (i.e. the majority of Korajac addons). This is set with the --load
# command-line option.
server_wide_modules = []
