...
term representation was ['=', 'company_id.name', 'Korajac']. Used in a
...
Korajac will use the SQL function 'unaccent' when available for the
...
Finally, to instruct Korajac to really use the unaccent function, you have to
...
def get_unaccent_wrapper(cr):
    if zira.registry(cr.dbname).has_unaccent:
