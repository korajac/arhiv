...
"""
The PostgreSQL connector is a connectivity layer between the Korajac code and
...
class Cursor(object):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as Korajac, we need the best guarantees that no data
        ...
        Korajac implements its own level of locking protection
        ...
        the default transaction isolation level for Korajac cursors, as
...
def close_db(db_name):
    """ You might want to call zira.modules.registry.Registry.delete(db_name) along this function."""
    global _Pool
    if _Pool:
